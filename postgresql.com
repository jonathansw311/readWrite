...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-11-26T23:14:43.072433" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/postgresql-jdbc-4270-released-2753/">PostgreSQL JDBC 42.7.0 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-11-23 by JDBC Project</li>
              </ul>
            </li>
 ...
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6eB"> Indexing TIMESTAMPs</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Bruce Momjian</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-11-22</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6ez"> I figured out why pg_dump was failing with PostgreSQL 15-16</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6eC"> Fun with Postgres Looped Functions and Linear Progressions</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Greg Sabino Mullane</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-11-22</li>
            </ul>
